...
namespace Silverback.Messaging.Broker.Kafka
{
    internal sealed class ConsumerChannelsManager : IDisposable
    {
            ...
            ISilverbackLogger logger)
        {
            ...
            _maxDegreeOfParallelism = consumer.Endpoint.MaxDegreeOfParallelism;
        ...
        private async Task ReadChannelOnceAsync(PartitionChannel partitionChannel)
        {
            ...
            if (_partitionChannels.Count > _maxDegreeOfParallelism)
            {
            ...
            {
                if (_messagesLimiterSemaphoreSlim.CurrentCount < _maxDegreeOfParallelism)
